 ...
 * @property {number} BiBei=4 BiBei value
 */
 ...
 * @property {number} BiBeiRet=5 BiBeiRet value
 */
$root.ReMsgIDS2C = (function() {
    ...
    values[valuesById[5] = "BiBeiRet"] = 5;
    return values;
})();
...
$root.LineInfo = (function() {
     ...
     * @property {number|null} [Start] LineInfo Start
     */
...
$root.BetRes = (function() {
    ...
    BetRes.encode = function encode(message, writer) {
        ...
        if (message.XiaoMaLi != null && message.hasOwnProperty("XiaoMaLi"))
            writer.uint32(/* id 6, wireType 0 =*/48).int32(message.XiaoMaLi);
...
$root.C2SBiBei = (function() {

    /**
     * Properties of a C2SBiBei.
     * @exports IC2SBiBei
     * @interface IC2SBiBei
     * @property {number|null} [Result] C2SBiBei Result
     */

    /**
     * Constructs a new C2SBiBei.
     * @exports C2SBiBei
     * @classdesc Represents a C2SBiBei.
     * @implements IC2SBiBei
     * @constructor
     * @param {IC2SBiBei=} [properties] Properties to set
     */
    function C2SBiBei(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @static
     * @param {IC2SBiBei=} [properties] Properties to set
     * @returns {C2SBiBei} C2SBiBei instance
     */
    C2SBiBei.create = function create(properties) {
        return new C2SBiBei(properties);
    };
     ...
     * @memberof C2SBiBei
     * @static
     * @param {IC2SBiBei} message C2SBiBei message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    C2SBiBei.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
     ...
     * @returns {$protobuf.Writer} Writer
     */
    C2SBiBei.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {C2SBiBei} C2SBiBei
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    C2SBiBei.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.C2SBiBei();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    C2SBiBei.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    C2SBiBei.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.Result != null && message.hasOwnProperty("Result"))
     ...
     * @returns {C2SBiBei} C2SBiBei
     */
    C2SBiBei.fromObject = function fromObject(object) {
        if (object instanceof $root.C2SBiBei)
            return object;
        var message = new $root.C2SBiBei();
     ...
     * @memberof C2SBiBei
     * @static
     * @param {C2SBiBei} message C2SBiBei
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    C2SBiBei.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults)
     ...
     * @returns {Object.<string,*>} JSON object
     */
    C2SBiBei.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
...
$root.S2CBiBeiRes = (function() {

    /**
     * Properties of a S2CBiBeiRes.
     * @exports IS2CBiBeiRes
     * @interface IS2CBiBeiRes
     * @property {number|null} [Dice1] S2CBiBeiRes Dice1
     * @property {number|null} [Dice2] S2CBiBeiRes Dice2
     * @property {number|Long|null} [Gold] S2CBiBeiRes Gold
     */

    /**
     * Constructs a new S2CBiBeiRes.
     * @exports S2CBiBeiRes
     * @classdesc Represents a S2CBiBeiRes.
     * @implements IS2CBiBeiRes
     * @constructor
     * @param {IS2CBiBeiRes=} [properties] Properties to set
     */
    function S2CBiBeiRes(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * S2CBiBeiRes Dice1.
     * @member {number} Dice1
     * @memberof S2CBiBeiRes
     * @instance
     */
    S2CBiBeiRes.prototype.Dice1 = 0;
     ...
     * @instance
     */
    S2CBiBeiRes.prototype.Gold = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
     ...
     * @static
     * @param {IS2CBiBeiRes=} [properties] Properties to set
     * @returns {S2CBiBeiRes} S2CBiBeiRes instance
     */
    S2CBiBeiRes.create = function create(properties) {
        return new S2CBiBeiRes(properties);
    };
     ...
     * @memberof S2CBiBeiRes
     * @static
     * @param {IS2CBiBeiRes} message S2CBiBeiRes message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    S2CBiBeiRes.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.Dice1 != null && message.hasOwnProperty("Dice1"))
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.Dice1);
        if (message.Dice2 != null && message.hasOwnProperty("Dice2"))
            writer.uint32(/* id 2, wireType 0 =*/16).int32(message.Dice2);
        if (message.Gold != null && message.hasOwnProperty("Gold"))
            writer.uint32(/* id 3, wireType 0 =*/24).int64(message.Gold);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    S2CBiBeiRes.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {S2CBiBeiRes} S2CBiBeiRes
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    S2CBiBeiRes.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.S2CBiBeiRes();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
                message.Dice1 = reader.int32();
                break;
            case 2:
                message.Dice2 = reader.int32();
                break;
            case 3:
                message.Gold = reader.int64();
                break;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    S2CBiBeiRes.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    S2CBiBeiRes.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.Dice1 != null && message.hasOwnProperty("Dice1"))
     ...
     * @returns {S2CBiBeiRes} S2CBiBeiRes
     */
    S2CBiBeiRes.fromObject = function fromObject(object) {
        if (object instanceof $root.S2CBiBeiRes)
            return object;
        var message = new $root.S2CBiBeiRes();
     ...
     * @memberof S2CBiBeiRes
     * @static
     * @param {S2CBiBeiRes} message S2CBiBeiRes
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    S2CBiBeiRes.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
     ...
     * @returns {Object.<string,*>} JSON object
     */
    S2CBiBeiRes.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
